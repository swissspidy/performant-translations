 ...
 */
class Performant_Translations_Tests_64 extends WP_UnitTestCase {
	...
	public function test_init() {
		...
		$this->assertSame( 10, has_action( 'init', array( Performant_Translations::class, 'set_locale' ) ) );
		$this->assertSame( 10, has_action( 'change_locale', array( Performant_Translations::class, 'change_locale' ) ) );
